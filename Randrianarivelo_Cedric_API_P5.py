...
st.image('https://plus.unsplash.com/premium_photo-1663075847012-c781e0d194ce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTl8fGRhdGElMjBzY2llbmNlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60', use_column_width=True)
...
st.write('Cet outil utilise un modèle de classification de sentiment NLP préalablement entraîné sur un ensemble de données de commentaires en ligne. Il peut prédire si un texte est positif, négatif ou neutre en fonction de son contenu. Essayez-le maintenant pour voir à quel point il est précis et utile !')
